      ...
      <Container>
        <GenericHtml>
          ...
          <p>
            ...
            trabalho em blocos de tempo (os famosos "Pomodoro") intercalados
          ...
          <h2>
            Mas no <strong>Relogio Atividades</strong> tem um diferencial 🚀
          </h2>
          ...
          <h2>Por que usar o Relogio Atividades?</h2>
          <ul>
